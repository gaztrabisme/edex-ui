...
function Clock() {
	...
	return (
		<div class="font-united_sans_light flex h-[7.41vh] w-full items-center justify-around pt-[0.5vh] font-extrabold sm:text-3xl md:text-5xl lg:text-7xl xl:text-9xl">
			{clockText()}
		</div>
	);
}
